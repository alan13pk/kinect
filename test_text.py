...
def draw_rect(frame,depth):
    ...
    if(state_rect == "start_rect"):
        if(sum_boolean > check_rect):
            ...
            cv2.putText(crop_frame,text[number_rect], (rectx,recty+recth), cv2.FONT_HERSHEY_SIMPLEX, 4, (0,255,0),5)
            ...
            cv2.putText(crop_frame,text[number_rect], (rectx,recty+recth), cv2.FONT_HERSHEY_SIMPLEX, 4, (0,0,255),5)
            start_time = time.time()
